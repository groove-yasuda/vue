    ...
    <v-app>
        <v-main>
            <v-container>
                ...
                <input-field label="基本給" v-model="input_Basic_Salary" :hint="numbers_Hint" :error="basic_Salary_Error" />
                <input-field label="交通費" v-model="input_Transport_Expens" :hint="numbers_Hint" :error="transport_Expens_Error" />
